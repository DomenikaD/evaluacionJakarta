...
a persistence unit "evaluacion63_delgadoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evaluacion63_delgado/pom.xml":
...
artifact ("evaluacion63_delgado.war") is already built. You can build
